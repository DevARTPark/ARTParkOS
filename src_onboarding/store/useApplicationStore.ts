...
export interface InnovatorProfile {
    ...
    city: string;
    country: string;
    educationLevel: string; // <--- ADDED THIS
...
export interface VentureProfile {
    ...
    // Innovator-in-Residence Specifics
    motivation: string;
...
const initialState = {
    ...
    innovator: {
        ...
        currentRole: '', organization: '', city: '', country: 'India', educationLevel: '', // <--- ADDED THIS
