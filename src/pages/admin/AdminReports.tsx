...
const availableReports = [
  ...
  {
    id: 2,
    title: "Q3 Govt. Compliance Summary",
    type: "Confidential",
    date: "Oct 10, 2023",
    size: "1.2 MB",
  },
  {
    id: 3,
    title: "Portfolio IP & Patent Portfolio",
    type: "Internal",
    date: "Nov 01, 2023",
    size: "2.8 MB",
  },
  {
    id: 4,
    title: "Job Creation & Economic Value",
    type: "Public",
    date: "Sep 20, 2023",
    size: "3.1 MB",
  },
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card className="bg-rose-50 border-rose-100">
              <CardContent className="p-6">
                <div className="flex justify-between items-start">
                  <div>
                    <p className="text-sm font-medium text-rose-700 uppercase tracking-wider">
                      Social Impact
                    </p>
                    <h3 className="text-4xl font-bold text-rose-900 mt-2">
                      1.2L+
                    </h3>
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-gray-500">
                  Cumulative beneficiary count over years
                </p>
              </CardHeader>
          ...
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                Comparing Revenue (Cr), Jobs, and Innovation (IP) across domains
              </p>
            </div>
            ...
            <CardContent className="p-8 flex flex-col md:flex-row items-center justify-between gap-6">
              <div>
                ...
                <p className="text-slate-300 max-w-xl">
                  Select specific metrics, timeframes, and sectors to build a
                  custom PDF report for Board Meetings or Government
                  submissions.
                </p>
              </div>
