...
// --- Mock Data ---
// 1. Variable defined here as "AIRLLevels"
const AIRLLevels = [
  ...
  {
    level: 5,
    def: "Technology validated in relevant environment",
    status: "Active",
  },
];
...
const auditLogs = [
  {
    id: 1,
    action: "Updated AIRL 3 Criteria",
    user: "Admin User",
    time: "2 hrs ago",
  },
  {
    id: 2,
    action: "Approved Grant Disbursement (Batch A)",
    user: "Finance Lead",
    time: "5 hrs ago",
  },
  {
    id: 3,
    action: "Added New Reviewer: Sarah Lee",
    user: "Admin User",
    time: "1 day ago",
  },
];
        ...
        <div className="flex-1 space-y-6">
          ...
          {activeTab === "governance" && (
            <Card>
              <CardHeader>
                <CardTitle>
                  Technology Readiness Level (AIRL) Definitions
                </CardTitle>
                <p className="text-sm text-gray-500">
                  These definitions appear on Founder assessments and Reviewer
                  forms.
                </p>
              </CardHeader>
              <CardContent className="space-y-4">
                {/* FIXED: Changed 'airlLevels' to 'AIRLLevels' to match the constant above */}
                {AIRLLevels.map((lvl) => (
                  <div
                    key={lvl.level}
                    className="flex gap-4 items-start p-3 bg-gray-50 rounded-lg border border-gray-100"
                  >
          ...
          {activeTab === "cycles" && (
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-gray-500">
                  Set deadlines for Monthly and Quarterly updates.
                </p>
              </CardHeader>
                ...
                <div className="bg-amber-50 p-4 rounded-lg border border-amber-100 flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-amber-700 mt-1">
                      If enabled, Founders cannot submit reports after the
                      deadline without Admin approval.
                    </p>
                    <div className="mt-2">
