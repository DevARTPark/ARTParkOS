  ...
  const handleAddTeam = () => {
    ...
    const teamToAdd = {
      ...
      expertise: newTeam.expertise
        .split(",")
        .map((s) => s.trim())
        .filter((s) => s), // Split comma-separated string
              ...
              <CardContent>
                <div className="mb-4">
                  <div className="flex justify-between text-xs mb-1">
                    ...
                    <span
                      className={`font-bold ${team.workload > 80 ? "text-red-500" : "text-green-600"}`}
                    >
                      {team.workload}%
                    </span>
                  </div>
                  ...
                  .map((task) => (
                    ...
                    >
                      <div className="flex justify-between items-start mb-2">
                        <Badge
                          variant={
                            task.priority === "High" ? "danger" : "neutral"
                          }
                ...
                {members.map((member) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <Badge
                        variant={
                          member.status === "Available" ? "success" : "warning"
                        }
                      >
                        {member.status}
                      </Badge>
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              ...
              <Input
                ...
                onChange={(e) =>
                  setNewTeam({ ...newTeam, expertise: e.target.value })
                }
              />
            </div>
            <div className="p-4 bg-gray-50 flex justify-end gap-3">
