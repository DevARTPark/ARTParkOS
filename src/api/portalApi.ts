import suppliersData from '../data/portal/suppliers.json';
import mentorsData from '../data/portal/mentors.json';
...
export const equipmentApi = {
    getAll: async (): Promise<Equipment[]> => {
        await simulateLatency();
        // Using 'unknown' cast to bypass strict JSON type inference vs Interface mismatch
        return equipmentData as unknown as Equipment[];
    },

    getById: async (id: string): Promise<Equipment | undefined> => {
        await simulateLatency();
        const all = equipmentData as unknown as Equipment[];
